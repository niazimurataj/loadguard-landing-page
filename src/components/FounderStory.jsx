      ...
      <div className={styles.container}>
        <div className={styles.textContainer}>
          ...
          <p className={styles.storyText}>
            Between 2022 and 2024, my family's banana export business was hit with over <strong>$2 million in narcotics-related compliance penalties</strong>, despite our complete innocence. We were victims of a broken system.
          </p>
          <p className={styles.storyText}>
